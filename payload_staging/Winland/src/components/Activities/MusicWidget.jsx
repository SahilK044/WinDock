    ...
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '14px 18px', boxSizing: 'border-box', fontFamily: MAC_FONT }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div className="track-change-wrapper" key={title} style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
          <MarqueeText style={{ fontSize: 14, fontWeight: 700, color: '#ffffff', lineHeight: '18px', letterSpacing: '-0.2px' }}>
            {title}
          </MarqueeText>
          {artist && (
            <MarqueeText style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255, 255, 255, 0.6)', marginTop: 2, lineHeight: '16px' }}>
              {artist}
            </MarqueeText>
          )}
      ...
      <div style={{ marginTop: 6, marginBottom: 2, position: 'relative' }}>
        ...
        <div
          ...
          style={{ width: '100%', height: 6, background: 'rgba(255, 255, 255, 0.15)', borderRadius: 4, cursor: 'pointer', position: 'relative', overflow: 'hidden' }}
        >
          <div
            style={{
              width: `${isDragging ? (dragProgressMs / durationMs) * 100 : pct}%`,
              height: '100%',
              background: progressGradient,
              borderRadius: 4,
              transition: isDragging ? 'none' : 'background 0.8s ease, width 1s linear',
            }}
          />
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10, color: 'rgba(255, 255, 255, 0.45)', marginTop: 4, fontWeight: 600 }}>
          <span>{fmt(isDragging ? dragProgressMs : progressMs)}</span>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 32, marginTop: 4 }}>
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 6, color: 'rgba(255, 255, 255, 0.85)', display: 'flex', alignItems: 'center', transition: 'transform 0.15s cubic-bezier(0.34, 1.56, 0.64, 1)' }}
        >
          <SkipBack size={22} fill="rgba(255, 255, 255, 0.85)" color="rgba(255, 255, 255, 0.85)" />
        </button>
        ...
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 6, color: 'rgba(255, 255, 255, 0.85)', display: 'flex', alignItems: 'center', transition: 'transform 0.15s cubic-bezier(0.34, 1.56, 0.64, 1)' }}
        >
          <SkipForward size={22} fill="rgba(255, 255, 255, 0.85)" color="rgba(255, 255, 255, 0.85)" />
        </button>
